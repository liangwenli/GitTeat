  ...
  <div id="home">
    ...
    <div class="listbox">
      <ul v-for="(data) in goods" :key="data.id">
        <li class="list_pro" :data-id="data.gid" @click="goto(data.gid)">
          <div class="list_img">
    ...
    <div class="logo">
      <img
        class="logo_img"
        src="https://img.yzcdn.cn/upload_files/2018/06/15/FkdLchgBKMNh1ObAq_wWJAQJ0PPI.png"
        alt
      />
    </div>
